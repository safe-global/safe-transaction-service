...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='abi_hash',
            field=gnosis.eth.django.models.Sha3HashField(blank=True, default=None, null=True, unique=True),
        ),
        migrations.RunPython(add_hash_for_contract_abis, reverse_code=migrations.RunPython.noop),
    ]
