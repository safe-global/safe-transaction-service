...
coinmarketcap_client_mock = [CoinMarketCapToken(id=1659, name='Gnosis', symbol='GNO',
...
relay_token_client_mock = [{'address': '0x6810e776880C02933D47DB1b9fc05908e5386b96',
...
class TestCommands(TestCase):
    ...
    @mock.patch.object(Erc20Manager, 'get_info', autospec=True, return_value=Erc20Info('Gnosis', 'GNO', 18))
    @mock.patch.object(CoinMarketCapClient, 'get_ethereum_tokens', autospec=True,
                       return_value=coinmarketcap_client_mock)
    def test_update_tokens_from_coinmarketcap(self, coinmarketcap_client_get_ethereum_tokens_mock: MagicMock,
    ...
    @mock.patch.object(SafeRelayTokenClient, '_do_query', autospec=True, return_value=relay_token_client_mock)
    def test_update_tokens_from_relay(self, relay_token_client_do_query_mock: MagicMock):
