...
class TestZerionClient(TestCase):
    def test_zerion_client(self):
        ...
        expected = [
            UniswapComponent(address='0x1A5F9352Af8aF974bFC03399e3767DF6370d82e4', tokenType='ERC20', rate=0),
            UniswapComponent(address='0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', tokenType='ERC20', rate=0)
        ]
