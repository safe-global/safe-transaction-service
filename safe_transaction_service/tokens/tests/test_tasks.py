...
from ..tasks import (
    ...
    update_token_info_from_token_list,
)
...
class TestTasks(TestCase):
    ...
    def test_update_token_info_from_token_list(
        ...
        self.assertEqual(update_token_info_from_token_list.delay().result, 1)

        # Create another token in the list, both should be updated
        TokenFactory(address="0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599")
        self.assertEqual(update_token_info_from_token_list.delay().result, 2)
