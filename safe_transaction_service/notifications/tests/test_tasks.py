...
from safe_transaction_service.history.signals import build_message_payload
...
class TestViews(TestCase):
    def test_filter_notification(self):
        ...
        confirmation_notification = build_message_payload(
        ...
        transaction_notification = build_message_payload(
        ...
        pending_transaction_notification = build_message_payload(
            MultisigTransaction, multisig_transaction
        )[0]
        ...
        ) = build_message_payload(InternalTx, internal_tx)
    ...
    def test_send_notification_owner_task_called(self):
        ...
        payload = {
            ...
            "type": NotificationEventType.PENDING_MULTISIG_TRANSACTION.name,
