...
class TestCollectiblesService(TestCase):
    def test_get_collectibles(self):
        ...
        expected = [Collectible(name='DappCon2020', symbol='D20', address='0x202d2f33449Bf46d6d32Ae7644aDA130876461a4',
                                id=13,
