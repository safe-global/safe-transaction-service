...
from history.indexers.tx_processor import (SafeTxProcessor,
...
def set_failed_for_multisig_txs(apps, schema_editor):
    ...
    for multisig_tx in MultisigTransaction.objects.exclude(
        ...
        multisig_tx.failed = safe_tx_processor.is_failed(multisig_tx.ethereum_tx, multisig_tx.safe_tx_hash)
