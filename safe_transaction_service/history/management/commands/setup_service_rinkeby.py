...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        SafeMasterCopy.objects.create(address='0xb6029EA3B2c51D09a50B53CA8012FeEB05bDa35A',
                                      initial_block_number=4110083,
                                      tx_block_number=4110083)
        ProxyFactory.objects.create(address='0x12302fE9c02ff50939BaAaaf415fc226C078613C',
                                    initial_block_number=4110083,
                                    tx_block_number=4110083)
