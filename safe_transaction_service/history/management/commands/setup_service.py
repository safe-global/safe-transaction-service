...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.XDC: [
        ("0x3E5c63644E683549055b9Be8653de26E0B4CD36E", 54712487, "1.3.0+L2"),
        ("0xd9Db270c1B5E3Bd161E8c8503c55cEABeE709552", 54712487, "1.3.0"),
    ],
    EthereumNetwork.TXDC_TESTNET: [
        ("0x3E5c63644E683549055b9Be8653de26E0B4CD36E", 43095378, "1.3.0+L2"),
        ("0xd9Db270c1B5E3Bd161E8c8503c55cEABeE709552", 43095378, "1.3.0"),
    ],
}
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.XDC: [
        ("0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2", 54712487),  # v1.3.0
    ],
    EthereumNetwork.TXDC_TESTNET: [
        ("0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2", 43095378),  # v1.3.0
    ],
}
