...
from ...models import SafeL2MasterCopy

class Command(BaseCommand):
    help = "Insert SafeL2MasterCopy objects"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--version", help="Safe Version", required=False, default="1.3.0")
    ...
    def handle(self, *args, **options):
        ...
        initial_block_number = options["initial-block-number"]
        tx_block_number = options["tx-block-number"]
        ...
        # Create SafeL2MasterCopy object
        SafeL2MasterCopy.objects.create(
            address=address,
        ...
        self.stdout.write(self.style.SUCCESS(f"Created SafeL2MasterCopy for {mastercopy_address}"))
