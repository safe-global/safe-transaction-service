...
urlpatterns = [
    ...
    path('safes/<str:address>/delegates/', views.SafeDelegatesListView.as_view(),
         name='safe-delegates'),
    path('safes/<str:address>/delegates/<str:delegate_address>/', views.SafeDelegateDetailView.as_view(),
         name='safe-delegates'),
