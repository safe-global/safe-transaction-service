...
exec gunicorn --config gunicorn.conf.py --pythonpath "$PWD/safe_transaction_service" -b unix:$DOCKER_SHARED_DIR/gunicorn.socket -b 0.0.0.0:8888 config.wsgi:application
